...
<div class="page-content">
  ...
  <div class="d-flex flex-lg-row flex-md-row flex-xs-column justify-content-end h-75">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 d-flex justify-content-end">
      <div class="col-lg-3 inner-banner banner-course">
    ...
    <div class="col-lg-6 col-md-12 col-xs-12 d-flex flex-column gap-3">
      ...
      <div class="about-card d-flex flex-column gap-3">
          <div class="d-flex justify-content-between gap-3">
            <div data-content="content-about" class="col-4 d-flex justify-content-center  align-items-center about active-about">
             О нас
            </div>
            <div data-content="content-mission" class="col-4 d-flex justify-content-center align-items-center about">
              Миссия
            </div>
            <div data-content="content-cert" class="col-4 d-flex justify-content-center align-items-center about">
              Сертификат
            </div>
          </div>
